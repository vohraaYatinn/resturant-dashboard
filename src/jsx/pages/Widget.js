            ...
            <div className="card">
              ...
              <div className="card-body p-0">
                <div
                  style={{ height: "370px" }}
                  id="DZ_W_TimeLine"
                  className="widget-timeline dz-scroll height370 ps--active-y px-4 my-4"
                >
            ...
            <div className="card">
              ...
              <div className="card-body p-0">
                <div
                  style={{ height: "370px" }}
                  id="DZ_W_TimeLine1"
                  className="widget-timeline dz-scroll style-1 height370  ps--active-y my-4 px-4"
                >
                  <ul className="timeline">
                    <li>
                      <div className="timeline-badge primary"></div>
            ...
            <div className="card">
              ...
              <div className="card-body p-0">
                <div
                  style={{ height: "370px" }}
                  id="DZ_W_Todo1"
                  className="widget-media dz-scroll  ps--active-y my-4 px-4"
                >
                  <ul className="timeline">
                    <li>
