				...
				<div className="row">
                    ...
                    <div className="col-xl-12">
						<div className="card">
							<div className="card-header border-0">
								<h4 className="h-title mb-0 blog-title">Active News</h4>	
                    ...
                    <div className="col-xl-9 col-lg-7">
						<div className="row">
							<div className="col-xl-12">
								<div className="card">
									<div className="card-header border-0">
										<h4 className="h-title mb-0 blog-title">Active users</h4>
										<Link to={"#"} className="btn btn-primary btn-sm">More</Link>
									</div>
									<div className="card-body pt-0">
										<div className="blog-img">
                    ...
                    <div className="col-xl-3 col-lg-5">
						<div className="card-header border-0 pt-0 px-0">
							<h4 className="h-title mb-0 blog-title">POPULAR POSTS</h4>
						</div>
						...
						<div className="mb-4">
							<ul className="c-social">
								<li><a href="https://www.facebook.com/dexignzone" target="_blank" rel="noreferrer"  className="bg-facebook"><i className="fa-brands fa-facebook-f"></i></a></li>
								<li><a href="https://www.whatsapp.com/" target="_blank"  rel="noreferrer"  className="bg-whatsapp"><i className="fa-brands fa-whatsapp"></i></a></li>
								<li><a href="https://www.linkedin.com/in/dexignzone" target="_blank" rel="noreferrer"  className="bg-linkedin"><i className="fa-brands fa-linkedin-in"></i></a></li>
								<li><a href="skype:rahulxarma?chat" className="bg-skype"  rel="noreferrer" ><i className="fa-brands fa-skype"></i></a></li>
							</ul>
						</div>
							...
							<div className="card-body">
								...
								<div className="notify-data">
									...
									<form onClick={(e)=>submitHandle(e)}>
										<div className="mt-3">
										  <input type="email" className="form-control form-control-sm" id="exampleInputEmail1"  placeholder="Enter Email" />
