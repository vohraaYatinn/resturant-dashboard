                                ...
                                <div className="col-xl-3 col-lg-6 col-sm-5 chat-border mobile-chat chat-left-area">
                                    <div className="chat-p shaprate">
                                        <div className="d-flex">
                                            <img src={IMAGES.contact5} className="avatar avatar-sm  rounded-circle" alt="" />
                                            <div className="ms-2">
                                            ...
                                            <span className="input-group-text">
                                                <Link to={"#"}>
                                                    <svg width="18" height="19" viewBox="0 0 18 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <circle cx="8.82495" cy="9.32491" r="6.74142" stroke="#0D99FF" strokeLinecap="round" strokeLinejoin="round"/>
                                                        <path d="M13.5137 14.3638L16.1568 16.9999" stroke="#0D99FF" strokeLinecap="round" strokeLinejoin="round"/>
                                                    </svg>
                                                </Link>
                                            </span>
                                        </div>
                                    ...
                                    <div className="people-list dz-scroll">
                                        {chatList.map((item, index)=>(
                                            <div className="chat-p style-1" key={index}>
                                                <div className="d-flex">
                                                    <img src={item.image} className="avatar avatar-sm  rounded-circle" alt="" />
                                                    <div className="ms-2">
                                ...
                                <div className="col-xl-5 col-lg-6 col-sm-7 chat-border">
                                    <div className="chat-p shaprate">
                                        ...
                                        <div className="chat-admin">
                                            ...
                                            <div className="icon-box bg-success mx-1">
                                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <div className="icon-box bg-primary mx-1">
                                            ...
                                            <Dropdown className="custom-dropdown mx-1">
                                                <Dropdown.Toggle className="btn sharp btn-primary light i-false" as="div">
                                                    {SVGICON.DropDots}
                                                </Dropdown.Toggle>
